<div class="modal-dialog modal-primary">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title"> ADD NEW POINT STUDENT</h4>
		</div>
		<form role="form" method="post" id="add-point-form">
			<div class="modal-body">
				...
				<div style="margin-bottom: 20px;" class="input-group">
					...
					{{ Form::text('point','', array('class' => 'form-control', 'placeholder' => 'Point Student','required' => '')) }}
				</div>
			</div>
			<div style="height: 60px; margin-top: 20px;" class="modal-footer">
				<div style="margin-bottom: 25px;"class="form">
					<button type="submit" class="btn btn-square btn-success" id="pointSave">
