<div class="modal-dialog modal-primary">
	<div class="modal-content">
		...
		<form role="form" method="post" id="add-student-form">
			<div class="modal-body">
				<div style="margin-bottom: 20px;" class="input-group">
					<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
					{{ Form::text('name','', array('class' => 'form-control', 'placeholder' => 'Student Name','required' => '')) }}
				</div>
				<div style="margin-bottom: 20px;" class="input-group">
					<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
					{{ Form::text('birthday','', array('class' => 'form-control input-birthday-picker', 'placeholder' => 'BirthDay (yyyy/mm/dd)','required' => '')) }}
				</div>
			...
			<div style="height: 60px; margin-top: 20px;" class="modal-footer">
				<div style="margin-bottom: 25px;"class="form">
					<button type="submit" class="btn btn-square btn-success" id="studentSave">
