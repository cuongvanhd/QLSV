<div class="modal-dialog modal-default">
	<div class="modal-content">
		...
		<form role="form" method="post" id="add-subject-form">
			<!-- {{ Form::open(array('class' => 'form-horizontal', 'role' => 'form', 'method' => 'POST' )) }} -->
			<div class="modal-body">
					<div style="margin-bottom: 20px;" class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
						{{ Form::text('name','', array('class' => 'form-control', 'placeholder' => 'Subject','required' => '')) }}
					</div>
			</div>
			<div style="height: 60px; margin-top: 20px;" class="modal-footer">
				<div class="form">
					<button type="submit" class="btn btn-square btn-success" id="subjectSave"><span class="glyphicon glyphicon-floppy-save"></span>Save</button>
